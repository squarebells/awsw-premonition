...
#Part 1, PC comes home from work
    ...
    m "I adjusted my position on the couch to help me calm down and to reflect on the feeling of impending doom I was feeling."
    ...
    Nm concern flip "That sounds serious. I know how much you love cooking. Are you feeling down because of the thing we talked about earlier?"
    ...
    stop music fadeout 1.0
    Nm smile flip "I'm here for you if want to figure out what's real."
    c "You have no idea how much you saying that helps."
...
#Part 2, trying to move on
    c "So, what do you think about the outcome of this timeline?"
...
#Part 3, the guilt
    ...
    Nm surprisedblush flip "Oh, thank you. I feel the same way."
    ...
    c "Agreed. Anyway, to continue my line of thought, I had initially placed great hopes in our inter-species cooperation. Your idea was a stroke of genius."
    ...
    Nm stern flip "Don't feel bad about it. You should remember that the task you were given was nigh-impossible due to circumstances outside your control."
    Nm normal flip "We did the best we could."  
    c "I guess I should finally believe you on that. I suppose it's time to finally let go."
    c "Let's just focus on us from now on." 
    c "Anyway, one more thing and I'm done unpacking all my problems on you."
    ...
    c "From a scientific standpoint, remembering things from alternate realities makes no sense at all."
    ...
    c "Naomi, I know I sound crazy, but I have no idea how to break from this."
    c "I understand how reification works and we should fight against it whenever we can, but honestly for the first time in my life I'm in a situation in which there is absolutely nothing I can do to resist the powers that be."
    c "In the end the most shocking realization is that I can't be entirely sure if even my life before arriving here is real."
    show naomi concern flip with dissolve    
...
#Part 4, the eating
    ...
    m "(Hmm... I don't feel like eating pizza tonight.)"
    ...
    m "(I guess right now it's better to just keep my eyes looking ahead and do my best to avoid going crazy.)"
    $ renpy.pause (1.0)
    m "(I wonder if Naomi actually went to just raid my fridge? Also, why does she eat the bacon raw?)"
    $ renpy.pause (2.0)
    m "(I can't wait to eat.)"
    m "After a couple of minutes Naomi returned, moving carefully while carrying a pitcher full of juice in her free hand."
    play sound "fx/glassdown.wav"
    show naomi blank at center with easeinright
    m "She placed the pitcher on the table."
    m "I got off the couch."
    c "Thank you. I'll go get the glasses."
    Nm "Sure."
    c "I still feel a bit down. Could I please get a dragon hug before I go?"
    stop music fadeout 1.0
    Nm smile "Of course."
    m "I got off the couch and walked up to her. As I placed my arms around her neck she shifted herself closer and hugged me back."
    m "She held me tightly and placed her wings around me. Lastly, she wrapped her tail loosely around my ankles."
    play music "mx/airborne.mp3"
    Nm slsmile "Looks like I caught a human. I'm so hungry right now I might eat you because you didn't cook me dinner."
    Nm smile "I think I'll eat you in a different way. I like having you around for cuddling."
    Nm "What if I pushed you to the floor and we had sex right now?"
    ...
    c "Yes... Naomi. I'll listen to you more from now on."
    show naomi smile with dissolve
