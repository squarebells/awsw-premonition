...
label sqb_naomi_m4_start:
    ...
    m "Sebastian was about to say something, but then he stopped and looked away."
    $ renpy.pause (1.0)
...
label sqb_naomi_m4_pool:
    ...
    Nm normal "Just put them on the lounge chair over there. I think it's far enough from the pool, so I can avoid splashing any water over there."
    ...
    Nm "Those windows are also almost completely opaque to anyone trying to look in from the outside, so you won't have to worry about any flying dragons or someone using binoculars peeking at your private parts."
...
label sqb_naomi_m4_returndiscussion:
    ...
    Nm sad "Yeah, there's a high chance of that happening. If you go through the portal I will most likely never see you again."
    c "Don't worry, I will stay with you no matter what comes."
...
label sqb_naomi_m4_funparts:
    ...
    Nm confused "Phew, that was close. Are you okay?"
    ...
    c "Yeah, I don't want to hurt myself. That would really ruin this evening. I think we should try new positions next time we do it in bed. There we can experiment safely."
    ...
    m "I stroked my dick to harden it as I got over to Naomi. Next to her, I positioned myself between her large thighs, sitting on the base of her tail."
    ...
    c "You training your body to become strong makes you very hot. Still, you forgot how your thighs would be great toys for squeezing while I fuck you."
    show naomi shy with dissolve    
    c "I'll be sure to feed and exercise you a lot so you stay in shape."
    Nm smile "I would like that a lot. Please feed my egg-hole a lot of your human seed as well."
    $ renpy.pause (2.0)
    ...
    c "Be careful, Naomi!"
    Nm shy "I'm..."
    m "Naomi came with a cry of ecstasy. Her vaginal walls clamped on my dick, desperate to milk me dry. Thankfully, she didn't break any of my bones in her excitement."
    ...
    stop soundloop fadeout 1.0
    play soundloop "fx/lewd/penfast.ogg"
    m "After her orgasm, Naomi released her full-body grip on me as she went half-limp. Even though she was out of it, I resumed fucking her rapidly, in order to reach my own release."
    ...
    show naomi shy with dissolve
    m "Naomi pulled me out of her in order to lift me up in front of her snout. Then she kissed me passionately."
    show naomi smile with dissolve
