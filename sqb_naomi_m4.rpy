...
label sqb_naomi_m4_start:
    ...
    Nm "Those windows are also almost completely opaque to anyone trying to look in from the outside, so you won't have to worry about any dragons peeking at your private parts by flying around the window or by using binoculars."
    ...
    c "Yeah, I noticed. I like a bit of alcohol every now and then, and you could even say I consume it regularly. Still, I admit that drinking almost every day like Bryce does is very bad for you both physically and mentally."
    ...
    show naomi normal with dissolve
    c "Those are obviously not good things to do, but they're still something that everyone doesn't have the willpower for."
...
label sqb_naomi_m4_returndiscussion:
    ...
    $ renpy.pause (2.0)
    c "I know, I was just joking. Of course I'll stay with you. I don't want us to be separated."
    show naomi smile with dissolve
    ...
    c "If this mission fails and the relations between our peoples go hostile, it would be unfair to expect me to fix anything because none of this is my fault in the first place."
    ...
    Nm concern "That's a very harsh decision to make. Are you sure you want to abandon your people like that?"
    ...
    Nm smile "Alright. It seems that's settled then."
