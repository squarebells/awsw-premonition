...
label sqb_naomi_m5_rezatalk2:
    ...
    c "It seems as if we have always been on the wrong track, always leading to our inevitable destruction. Maybe it's time to try a different path?"
    $ renpy.pause (2.0)
    ...
    c "The comet will destroy almost everything. Again, even if someone was being purely pragmatic, that would be a huge waste of resources." 
    ...
    Rz "You're so stupid. Did you forget that we're in the past?!" 
    Rz amused "If the dragons don't get wiped out, humans would never come to exist. Humans not existing would create a kind of a grandfather paradox, because we created the dragons, but due to our actions the dragons would be the reason humans never existed."
    c "..."
    c "You don't know that for sure!"
    Rz "It's the only logical conclusion."
    $ renpy.pause (2.0)
    c "You're wrong. I know there's already been multiple timelines, so if the portal actually sent people to the past of their own world, the paradox would have surely happened already."
    ...
    Rz amused "Besides, you were right earlier. I'm mostly doing this because I want to become a dictator. I'm the only one ruthless and worthy enough to lead humanity to another golden age. You either follow me or you die."
...
label sqb_naomi_m5_rezafight:
    ...
    c "Yeah, they don't really seem to care about me."
    ...
    c "You're wrong but it's whatever. I don't even care about that any more because I agreed with Naomi that I'm going to stay here and never go back to my own world."
    ...
    Nm "You have such a big heart, [player_name]. Always looking to save as many people as possible."   
...
label sqb_naomi_m5_maverick:
    ...
    c "Look, your conclusions were reasonable based on the information you had available at the time. I understand why it seemed to you that I blindly trusted my superiors, without realizing that I was being used, just not the way you though." 
    c "To be frank, I was kind of used as a decoy."
    c "In other words you were right to suspect the motivations of my city-state's leadership. If we manage to get out of this incident without ruining the relations between our peoples, I would still be very suspicious when interacting with them."
    c "Still, don't automatically start blaming the regular people, who are just trying to survive in our harsh world. In factr, to make sure we get along nicely, I'll do my best to make sure that my people won't be able to exploit yours."
...
label sqb_naomi_m5_ending:
#I can't be bothered to make a million new labels any more, so copy paste it is  
    show naomi normal with dissolve
    ...
    Nm "Thank you."
    c "How did you come up with it?"
    Nm normal "Back when we were stuck in that underwater lab faced with death, instead of just rushing through the very first idea I got, I stopped for a moment and analyzed the situation." 
    ...
    Nm blank "This time, I realized that Reza is going to have to come out of from under the portal at some point. Also, confronting him in a narrow well-lit corridor was out of the question, because he had a long-range weapon."
    ...
    Nm normal "Thank you. In the end you are are unharmed, and that is all that matters to me."
    ...
    c "No, I actually don't. There's no way in hell I am going to risk my life like this ever again. Also, I might end up messing things up really badly on my next try. I think this timeline is a pretty good one to stop at."
    show naomi smile with dissolve
    ...
    Nm "I'm relieved. You have no idea how worried I was there for a second. Thank you for choosing to stay with me. I promise you we will have a great future together."
    c "Likewise. Like I said, there is nothing I wouldn't do for you."
    $ renpy.pause (2.0)
    ...
    n "When I returned to my apartment in the dark of night, I found Naomi waiting at the locked front door. She stayed overnight, and the next day we had a great time just hanging out and planning our lives together. The future seemed bright, and I had never been this happy before in my entire life."
    ...
    n "The choices presented were to either accept the consequences and give up on my mission and live my life among dragons or to use the portal to return to the day of my arrival. This debate in my head was entirely hypothetical of course." 
    n "I could never leave Naomi, for what, a chance to die again? Abandoning her would be very cruel and besides, why should I be responsible for trying to get the perfect solution?"
    ...
    c "If you want to try and convince me to change to mind, I'll let you know upfront that my decision is final. In fact, I have the police department on speed dial in case you start acting in a hostile manner towards me. You're not going to drag me to the portal."
    ...
    c "[player_name]."
    As "I'd have loved to say \"the one and only\" but sadly it's not the case anymore."  
    ...
    c "Wait, how many other timelines do you think there are?"
    As "The portal is tampering with our memories so none of us can even imagine, I'm afraid."
    c "I see."
    c "Good luck in your mission."   
    As "Thank you. I think I'm going to need it since I am going to try my best to prevent the disaster that happened to me from happening again. Hopefully for good."
...
label sqb_naomi_m5_aftermath:
    ...
    c "Hey."
    Nm "I have a day off, so have you thought of anything to do? Do you want to go see some new place or just hang out over here?"
    ...
    c "Well...{w} how should I begin?"
    c "Okay, I'm not kidding. Last night I was visited by an alternate version of myself."
    Nm surprised "No way."
    ...
    Nm "Yeah."
    c "My alternate self was going to ask me to take the portal back in time to an alternate timeline, and wanted to take my place in this one. What really tops it all, is that they were going to tell everyone they were the fake version of me."
    show naomi stern with dissolve
    c "Needless to say, I would have never agreed to that."
    Nm "That's really messed up. I don't know how I would react to someone who looks and sounds like you but I know to not really be the one I love."
    c "Oh well, there's no need to speculate about that. After they saw how well our current timeline went, they had the courtesy to not even ask me to sacrifice myself."
    ...
    Nm blank "Wait."
    Nm stern "Your alternate self been visiting other timelines and observing countless other versions of me?"
    ...
    c "You're right. All this multiverse speculation is really pointless right now. The best course of action would be to completely forget about it."
    $ renpy.pause (2.0)
    c "So, what do you want to do today? As you can see, I still don't have a television so we can't watch any of your series."
    Nm smile "I just came up with a great schedule for today. First, how about a few cuddles?"
    ...
    m "Still firmly trapped, I wrapped one arm around Naomi in order to cuddle her to sleep, while also gently running my hand along her neck."
    m "She mumbled something inaudible and shifted to put her chin on top of my head."
    $ renpy.pause (1.0)
    show naomi sleep with dissolve
    m "Feeling her breathing and heartbeat peacefully slow down, I switched most of my attention to listening to her. Since this couch was smaller than what we had before cuddled on, I was feeling little uncomfortable, but I decided against disturbing Naomi's nap."
    ...
    m "(I love her so much. I wonder what the future will bring.)"
    stop music fadeout 1.0
    $ renpy.pause (2.0)
